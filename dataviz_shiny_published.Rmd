...
## Short introduction {.columns-2 .smaller}
```{r, echo=FALSE, out.width='25%', fig.align='center', fig.cap=''}
knitr::include_graphics('meetup-figure/Jens_Portraitjpg.png')
```
...
knitr::include_graphics('meetup-figure/kammer.png')
knitr::include_graphics('meetup-figure/campusbavaria.png')
```
...
knitr::include_graphics('meetup-figure/meetup_ds_RStudio.png')
```
...
knitr::include_graphics('meetup-figure/cicd.png')
```
...
```{r, echo=FALSE, out.width='75%', fig.align='center', fig.cap=''}
knitr::include_graphics('meetup-figure/Linkdin.png')
```
<p class="forceBreak"></p><p class="forceBreak"></p>
Dr. Jens Hofmann
